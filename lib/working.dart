...
void initializeHives() async{
  ...
  await popularSeriesData.add({
    ...
    "year": "2018",
    "genre": "Drama",
    "trailer": "https://youtu.be/qwOWJ8pPgk8?feature=shared",
  ...
  await originalsData.add({
    ...
    "year": "2020",
    "genre": "Drama",
    "trailer": "Anya Taylor-Joy, Bill Camp, Marielle Heller",
  ...
  await originalsData.add({
    ...
    "year": "2024",
    "genre": "Drama",
    "trailer": "Sofía Vergara, Alberto Guerra, Christian Tappan",
  ...
  await originalsData.add({
    ...
    "year": "2022",
    "genre": "Fantasy",
    "trailer": "Jenna Ortega, Gwendoline Christie, Riki Lindhome",
  ...
  await originalsData.add({
    ...
    "year": "2020",
    "genre": "Drama",
    "trailer": "Adjoa Andoh, Julie Andrews, Lorraine Ashbourne",
  ...
  await originalsData.add({
    ...
    "year": "2015",
    "genre": "Drama",
    "trailer": "Wagner Moura, Pedro Pascal, Boyd Holbrook",
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: MovieSection(title: 'Top 10 - Pakistan', content: 'top10ro'),
            ),
            Container(
              margin: const EdgeInsets.all(30),
            ...
            Container(
              margin: const EdgeInsets.all(30),
              child: SpecialSection(title: 'Recommended'),
            ),
          ],
        ),
      ),
