    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color.fromARGB(1, 110, 1, 1),
...
class HomePage extends StatelessWidget {
  ...
  final Map<String, dynamic> data = {
    ...
    'trailer': "Meryl Streep, Anne Hathaway, Stanley Tucci, Simon Baker, Emily Blunt, Adrian Grenier",
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            const NavBar(),
            Header(data: data, imgPath: 'assets/logo.png'),
            Container(
              margin: const EdgeInsets.all(30),
              child: MovieSection(title: 'Top 10 - Pakistan', jsonFile: 'jsonData/top10ro.json'),
            ),
            Container(
              margin: const EdgeInsets.all(30),
            ...
            Container(
              margin: const EdgeInsets.all(30),
              child: SpecialSection(title: 'Recommended', jsonFile: 'jsonData/originals.json'),
            ),
          ],
        ),
      ),
...
class SeriesPage extends StatelessWidget {
  ...
  final Map<String, dynamic> data1 = {
    ...
    'trailer': "Nathan Fillion, Alyssa Diaz, Richard T. Jones",
...
class FilmsPage extends StatelessWidget {
  ...
  final Map<String, dynamic> data1 = {
    ...
    'trailer': "Tom Cruise, Miles Teller, Jennifer Connelly",
...
class NavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      backgroundColor: const Color.fromRGBO(1, 110, 1, 1),
      title: const Text("PakFlix", style: TextStyle(color: Colors.black, fontSize: 35, fontWeight: FontWeight.bold), ),
      actions: <Widget>[
        TextButton(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "imdb: ${data['imdb']}",
                style: const TextStyle(fontSize: 20, color: Colors.blue, decoration: TextDecoration.underline),
                textAlign: TextAlign.center,
